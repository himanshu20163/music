  ...
  return (
    ...
    <div className='w-full flex justify-between items-center font-semibold '>
        ...
        <div className='flex items-center gap-4'>
          <p className='bg-white text-black text-[15px] px-4 py-1 rounded-2xl hidden md:block'>Explore premimum</p>
    ...
    <div className='flex items-center gap-2 mt-4'>
       ...
       <p className='bg-black px-4 py-1 rounded-2xl'>Podcaste </p>
    </div>
    </>
  )
}
